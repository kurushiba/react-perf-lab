...
// before では memo() 済みだったが、親が profile を JSX 内でオブジェクトリテラルとして
// 作っていたため毎回参照が変わり、memo は効いていなかった（書き忘れ②）。
// Compiler は親側でそのオブジェクトをキャッシュするので、ここは memo なしで止まる。
export default function Sidebar({ profile, following, unreadCount }: SidebarProps) {
